...
ADDON_NAME = "TA_CTIS_TAXII_ES_AR"
...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        session_key,
        ADDON_NAME,
        realm=f"__REST_CREDENTIAL__#{ADDON_NAME}#configs/conf-TA_CTIS_TAXII_ES_AR_account",
    )
    account_conf_file = cfm.get_conf("TA_CTIS_TAXII_ES_AR_account")
